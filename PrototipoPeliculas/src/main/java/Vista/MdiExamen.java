 ...
 * @author visitante
 */
public class MdiExamen extends javax.swing.JFrame {
    ...
    public MdiExamen() {
        ...
        this.setExtendedState(MdiExamen.MAXIMIZED_BOTH);
        this.setTitle("");
        cerrar();
    ...
    private void initComponents() {
        ...
        mantenimientoUsuarios.setText("Mantenimiento Vendedores");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MdiExamen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
